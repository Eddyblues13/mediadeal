...
<section class="position-relative overflow-hidden py-2 px-4">
  ...
  <div class="row">
    <div class="col-md-4 mb-4">
      <div class="card radio-card p-3" style="width: 21rem;">
        ...
        <div class="card-body">
          <h5>Zaki Radio Station</h5>
          <p class="card-text">You can aire your Ad easily with Zaki Radio station. We are always here for you.</p>
        </div>
      </div>
    </div>
...
<section class="position-relative overflow-hidden px-4 py-2">
    ...
    <div class="row align-items-center">
      <div class="col-md-7 mb-2 px-5">
        ...
        <p class="small mb-0">Subscribe to our newsletter to get update as we add
          more radio stations, announce promo offers, and giveaways</p>
      </div>
